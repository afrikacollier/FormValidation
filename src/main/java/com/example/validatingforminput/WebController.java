...
public class WebController implements WebMvcConfigurer {
	 ...
	 *
	 *In the code, you test for errors. If you encounter an error, you can send the user back to 
	 *
	 *the original form template. In that situation, all the error attributes are displayed.
	 *
